...
C {devices/vsource.sym} 50 460 0 0 {name=V1 value=0 savecurrent=true}
C {devices/vsource.sym} 50 300 0 0 {name=V2 value=0 savecurrent=true}
C {devices/vsource.sym} 140 420 1 0 {name=V3 value=0 savecurrent=true}
C {devices/vsource.sym} 50 200 0 0 {name=V4 value=0 savecurrent=true}
