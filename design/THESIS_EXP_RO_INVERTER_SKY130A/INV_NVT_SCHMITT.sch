...
C {sky130_fd_pr/nfet_03v3_nvt.sym} 10 430 0 0 {name=M1[2:0]
W=1
L=0.6
nf=1
mult=1
...
C {sky130_fd_pr/nfet_03v3_nvt.sym} 10 610 0 0 {name=M2[29:0]
W=1
L=0.6
nf=1
mult=1
...
C {sky130_fd_pr/nfet_03v3_nvt.sym} 220 460 1 0 {name=M3[20:0]
W=1
L=0.6
nf=1
mult=1
...
C {devices/lab_pin.sym} 70 610 2 0 {name=p6 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 80 430 2 0 {name=p7 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 220 510 3 0 {name=p8 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 70 -40 2 0 {name=p9 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 70 160 2 0 {name=p17 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 220 60 1 0 {name=p18 sig_type=std_logic lab=VDD}
