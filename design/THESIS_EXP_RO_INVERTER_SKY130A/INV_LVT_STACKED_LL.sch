...
T {Body to ground. Cannot connect to source bc no ground. Body effect OK because NMOS below pulls to gnd.} -120 -340 0 0 0.4 0.4 {}
...
C {cborder/border_s.sym} 560 90 0 0 {
user="wulff"
company="wulff"}
...
C {JNW_LVT_ATR_SKY130A/JNWLVTATR_PCH_12C5F0.sym} -320 -630 3 1 {name=xThs[9:0]}
C {JNW_LVT_ATR_SKY130A/JNWLVTATR_PCH_12C5F0.sym} -290 -450 0 0 {name=xIhs[9:0]}
C {JNW_LVT_ATR_SKY130A/JNWLVTATR_PCH_12C5F0.sym} -310 -170 3 0 {name=xBhs[9:0]}
C {JNW_LVT_ATR_SKY130A/JNWLVTATR_NCH_4C5F0.sym} -200 -630 3 1 {name=xTls[9:0]}
C {JNW_LVT_ATR_SKY130A/JNWLVTATR_NCH_4C5F0.sym} -290 -330 0 0 {name=xIls[9:0]}
C {JNW_LVT_ATR_SKY130A/JNWLVTATR_NCH_4C5F0.sym} -180 -170 3 0 {name=xBls[9:0]}
