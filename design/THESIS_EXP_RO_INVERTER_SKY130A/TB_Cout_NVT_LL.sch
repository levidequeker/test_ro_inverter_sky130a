...
C {THESIS_EXP_RO_INVERTER_SKY130A/INV_NVT_feedback_longer.sym} -30 0 0 0 {name=x1}
...
C {THESIS_EXP_RO_INVERTER_SKY130A/INV_NVT_feedback_longer.sym} -30 230 0 0 {name=x2}
