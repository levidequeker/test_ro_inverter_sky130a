...
N 50 230 200 230 {lab=VOUT_TRAN}
...
C {THESIS_EXP_RO_INVERTER_SKY130A/INV_NVT_feedback_long.sym} -20 0 0 0 {name=x1}
C {devices/ipin.sym} -70 140 0 0 {name=p8 lab=VDD_TRAN}
C {THESIS_EXP_RO_INVERTER_SKY130A/INV_NVT_feedback_long.sym} -20 230 0 0 {name=x2}
C {devices/ipin.sym} -140 230 0 0 {name=p5 lab=VIN_TRAN}
C {devices/ipin.sym} -70 320 0 0 {name=p6 lab=VSS_TRAN}
C {devices/opin.sym} 200 230 0 0 {name=p7 lab=VOUT_TRAN}
