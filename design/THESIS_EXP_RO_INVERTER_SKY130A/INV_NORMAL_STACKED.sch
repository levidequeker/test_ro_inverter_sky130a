...
C {JNW_ATR_SKY130A/JNWATR_PCH_12C1F2.sym} -320 -630 3 1 {name=xhs1[9:0]}
C {JNW_ATR_SKY130A/JNWATR_NCH_4C1F2.sym} -200 -630 3 1 {name=xls1[9:0] }
C {JNW_ATR_SKY130A/JNWATR_NCH_4C1F2.sym} -180 -170 3 0 {name=xls2[9:0] }
C {JNW_ATR_SKY130A/JNWATR_PCH_12C1F2.sym} -310 -170 3 0 {name=xhs2[9:0]}
