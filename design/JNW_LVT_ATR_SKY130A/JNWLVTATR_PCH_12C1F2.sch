...
E {}
N 510 -0 530 0 {lab=G}
N 570 -30 590 -30 {lab=S}
N 570 0 590 -0 {lab=B}
N 570 30 590 30 {lab=D}
...
C {devices/lab_pin.sym} 590 30 2 0 {name=l6 sig_type=std_logic lab=D }
C {devices/lab_pin.sym} 510 0 0 0 {name=l7 sig_type=std_logic lab=G }
C {devices/lab_pin.sym} 590 -30 2 0 {name=l4 sig_type=std_logic lab=S }
